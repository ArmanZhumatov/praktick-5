...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng marker1 = new LatLng(52.2933428, 76.9809269); // Маркер ПГУ
    static final LatLng marker2 = new LatLng(52.2788758, 76.9788204); // Маркер ИнЕУ
    static final LatLng marker3 = new LatLng(52.2824901, 76.958664); // Маркер ИнЕУ
    static final LatLng marker4 = new LatLng(52.2747993, 76.9873531); // Маркер ИнЕУ
    static final LatLng marker5 = new LatLng(52.2861342, 76.9514603);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker1).title(getString(R.string.marker1_title)).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.pktik)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker2).title((getString(R.string.marker2_title))).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.sop)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker3).title((getString(R.string.marker3_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.zhusup)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker4).title((getString(R.string.marker4_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.batyr)).alpha(ALPHA).
                snippet(getString(R.string.marker3_txt_click)));

        mMap.addMarker(new MarkerOptions().position(marker5).title((getString(R.string.marker5_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.logo)).alpha(ALPHA).
                snippet(getString(R.string.marker3_txt_click)));
